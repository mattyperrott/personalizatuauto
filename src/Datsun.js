...
export function Model({ color, ...props }) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh castShadow receiveShadow geometry={nodes.Cylinder007_alloy_0_10.geometry} material={materials.paint} material-roughness={1} material-metalness={0.5} material-color={color} />
